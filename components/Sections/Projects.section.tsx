  ...
  return (
    <div className="my-16 px-3 font-sen" id="projects">
      ...
      <div className="my-8 flex flex-col items-center justify-center gap-10 sm:flex-row">
        <Link href="https://image-gallery-eight-lac.vercel.app/" passHref>
          <a
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Img Gallery</p>
              <p>Using Cloudinary API & NextJS for a gallery</p>
            </div>
          </a>
        </Link>

        <Link href="https://github.com/codelikeagirl29/react-portfolio" passHref>
          <a
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Portfolio / React</p>
              <p>Fun, minimal portfolio made with React.</p>
            </div>
          </a>
        </Link>
      </div>
